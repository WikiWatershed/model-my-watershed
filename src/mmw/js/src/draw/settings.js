...
var mmwSplashPageText = {
    ...
    drawToolTwoDescriptions: ['See land cover, soil groups, point sources and other factors impacting water.'],
    drawToolThreeName: 'Model',
    drawToolThreeDescriptions: ['Use one of two models to simulate different scenarios of human impacts on water.'],

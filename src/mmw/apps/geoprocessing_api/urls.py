...
urlpatterns = [
    ...
    re_path(f'jobs/{uuid_regex}/$', get_job, name='get_job'),
    ...
    re_path(f'modeling/subbasin/prepare/{uuid_regex}/huc12s/$',
            views.get_modeling_subbasin_huc12s,
            name='get_modeling_subbasin_huc12s'),

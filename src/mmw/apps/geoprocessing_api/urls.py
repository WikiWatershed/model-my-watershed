...
urlpatterns = [
    ...
    re_path(
           r"analyze/pointsource/$",
           views.start_analyze_pointsource_deprecated,
           name="start_analyze_pointsource_deprecated",
        ),
    re_path(r'analyze/pointsource/(?P<datasource>\w+)/?$',
            views.start_analyze_pointsource,
    ...
    re_path(r'analyze/global-streams/$',
            views.start_analyze_global_streams,
            name='start_analyze_global_streams'),

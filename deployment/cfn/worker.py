...
class Worker(StackNode):
    ...
    def get_cloud_config(self):
        return ['#cloud-config\n',
                ...
                '  - path: /usr/local/bin/setup-rwd-volume.sh\n',
                '    permissions: 0755\n',
                '    owner: root:root\n',
                '    content: |\n',
                '      #!/bin/bash\n',
                ...
                '      cat > /etc/systemd/system/opt-rwd\\\\x2ddata.mount << EOF\n',
                '      [Unit]\n',
                '      Description=RWD Data Volume\n',
                '      Before=mmw-rwd.service\n',
                '      \n',
                '      [Mount]\n',
                '      What=$RWD_DEVICE\n',
                '      Where=/opt/rwd-data\n',
                ...
                '      systemctl enable opt-rwd\\\\x2ddata.mount\n',
                '      systemctl start opt-rwd\\\\x2ddata.mount\n',
                '      exit 0\n',
                '\n',
                'rsyslog:\n',
                ...
                '\n',
                'runcmd:\n',
                '  - /usr/local/bin/setup-rwd-volume.sh\n',
                '  - systemctl restart mmw-rwd.service\n',
